<!-- ref_id: c023b542-ac52dc23-ae44847a-f514eaa7-7bb550fe-7a7c51fa-53c421ea -->
<!-- internal_id: dff79ae0-b386f381-b190abd8-eac0c505-64617f5c-65a87e58-4c100e48 -->
---
title: FlowDocument
---
...
The default style of the scrolling view of the stream document is not recommended. It should always be used by other styles as the BaseOn method.
...
The default style of the single page view of the stream document is not recommended. It should always be used by other styles as the BaseOn method.

# FlowDocumentReaderBaseStyle

The default style of the Streaming Document Viewer is not recommended. It should always be used by other styles as BasedOn.